    ...
    <div class="navbar-inner">
      <div class="container-fluid">
        ...
        <div class="nav-collapse collapse">
        	<form class="form-search s-widget" style="display:inline-block;">
              <div class="input-append">
                <input type="search" class="input-small search-query" style="width:300px;" placeholder="Cari Lokasi tujuan anda di sini">
