...
<div class="flat-carousal">
	...
	<?php endif; ?>	
                    ...
                    <h3 style="text-align:center; margin-left:15px; font-size:1.5em; background-color:#06F; color:#fff; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;">Selamat Datang di Medanisasi.com</h3>
